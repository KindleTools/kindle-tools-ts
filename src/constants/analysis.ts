/**
 * Constants related to content analysis and detection.
 *
 * These values are used for detecting duplicates, merging clippings,
 * and identifying noise or artifacts in book metadata.
 */
