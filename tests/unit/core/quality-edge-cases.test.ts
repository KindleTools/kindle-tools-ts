...
import { flagSuspiciousHighlights, flagFuzzyDuplicates } from "#core/processing/quality.js";
import { createClipping } from "../../fixtures/clipping.js"; // Relative import from tests/unit/core
import { SUSPICIOUS_HIGHLIGHT_THRESHOLDS } from "#domain/core/constants.js";
...
describe("Quality Processing Edge Cases", () => {
    ...
    describe("flagFuzzyDuplicates", () => {
        ...
        it("should handles skip if already flagged", () => {
            const c1 = createClipping({ id: "1", location: { start: 100, end: 110, raw: "" }, content: "Common words A B C" });
            const c2 = createClipping({ id: "2", location: { start: 100, end: 110, raw: "" }, content: "Common words A B D" });
            const c3 = createClipping({ id: "3", location: { start: 100, end: 110, raw: "" }, content: "Common words A B E" });
